...
def _meta_float(order: dict, key: str) -> float:
    for meta in order.get("meta_data", []) or []:
        if meta.get("key") == key:
            return _safe_float(meta.get("value"))
    return 0.0
        ...
        rows.append(
            {
                ...
                "regular_price": _safe_float(product.get("regular_price")),
                "sale_price": _safe_float(product.get("sale_price") or product.get("price")),
